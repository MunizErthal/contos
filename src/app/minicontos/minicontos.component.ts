...
@Component({
  selector: 'app-minicontos',
  templateUrl: './minicontos.component.html',
  styleUrls: ['./minicontos.component.css', './../../assets/css/bootstrap/bootstrap.min.css']
})
export class MinicontosComponent implements OnInit {
